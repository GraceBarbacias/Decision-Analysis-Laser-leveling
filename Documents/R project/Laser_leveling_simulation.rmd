...
(establishment_cost_LL \* 0.8)/5 \# fictive assumtion that maintenance
...
```{r monte-carlo-results, echo=TRUE}
gg <- decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_results, 
...
gg +
  scale_x_continuous(limits = c(-30000, 360000), breaks = seq(-100000, 200000, by = 50000))
```
...
decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_results, 
                                    ...
                                    colors = "#FFC300",
                                    x_axis_name = "Outcome distribution [USD] NPV (N = 10,000)",
                                    y_axis_name = "NDensity of Estimations")
