...
**(Bouman et al., 2007)**. Rice is a primary dietary staple for billions
of people, particularly in Asia, where it serves as a crucial source of
calories and nutrition **(Seck et al., 2012)**. Rice consumption has
...
in 2008/2009 **(Cuaton et al., 2022)**. To meet the growing demand for
rice and ensure stable food supplies, efficient water management is
...
consumption **(FAO, 2020; Yang et al., 2006)**. As water scarcity
becomes an increasing concern, optimizing water use in irrigated rice
fields is crutial **(Molden et al., 2010).**
...
significantly to the national economy **(Ngoc et al., 2012)**. However,
...
**(Tuan et al., 2014)**. To address these challenges, laser leveling
...
1.  Improved Water Management:
    ...
    across the rice fields **(Nguyen & Thang, 2019)**. By achieving a
    consistent water depth, laser leveling reduces water wastage,
    enhances irrigation efficiency, and minimizes the risk of both
    waterlogging and drought stress **(Ngoc et al., 2012)**.
...
2.  Increased Productivity and Yield:
    ...
    **(Tuan et al., 2014)**. These factors collectively contribute to
...
3.  Cost and Labor Savings:
    ...
    labor **(Nguyen et al., 2021)**. This not only saves costs
    associated with hiring and managing labor but also expedites the
    cultivation process, allowing for timely crop rotations and
    potentially increasing the number of planting cycles per year
    **(Hoang & Vien, 2018)**.
...
4.  Environmental Sustainability:
    ...
    runoff, preserving this valuable resource **(Ngoc et al., 2012)**.
    Additionally, by promoting uniform crop growth, it minimizes the
    need for excessive fertilizer and pesticide applications, thereby
    reducing chemical runoff and environmental pollution.
...
combination of data, models, and stakeholder preferences. Decision
analysis is a quantitative approach that aims to support decision-making
processes by explicitly considering uncertainties, trade-offs, and
potential consequences.

The "decisionSupport" R package incorporates decision analysis
techniques into a user-friendly software tool, allowing decision-makers
to analyze complex problems and evaluate alternative courses of action.
