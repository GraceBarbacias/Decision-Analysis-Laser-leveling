...
globally over the last decade. Statista data shows that, in the cropping
year 2020/2021, the world population consumed about 504.3 million metric
tons of rice, increasing from 437.18 million metric tons in 2008/2009
@cuaton_two_2022. To meet the growing demand for rice and ensure stable
food supplies, efficient water management is essential. However,
irrigated rice farming requires significant water resources, accounting
for a substantial portion of global freshwater consumption
@food__agriculture_organization_future_2018 @yang_water_2006. As water
scarcity becomes an increasing concern, optimizing water use in
...
3.  Cost and Labor Savings: Traditional manual leveling methods are
    ...
    reducing the need for manual labor @nguyen_evaluating_2021. This not
    only saves costs associated with hiring and managing labor but also
    expedites the cultivation process, allowing for timely crop
...
4.  Environmental Sustainability: Laser leveling helps mitigate negative
    ...
    @ngoc_benefits_2012. Additionally, by promoting uniform crop growth,
    it minimizes the need for excessive fertilizer and pesticide
...
It offers a flexible and customization platform for implementing
decision support methodologies, enabling users to perform sophisticated
decision analysis tasks efficiently.
...
laser leveling, as recommended by @oertle_potential_2019 where they
...
that we can implement this technology in Vietnam because the government
has run a program of "5 for 1 program" in Vietnam, to promote
...
design an input table, that is stored locally as **Test_Input.csv**,
this table contains all the input variables and each basic values used
in the model.
